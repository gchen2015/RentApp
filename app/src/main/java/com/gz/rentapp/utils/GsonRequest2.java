...
public class GsonRequest2<T> extends Request<T>{
    ...
    public GsonRequest2(int method, String url, Class<T> tClass1, Response.Listener<T> listener, Response.ErrorListener errorlistener) {
        super(method, url, errorlistener);
        gson=new Gson();
        this.tClass=tClass1;
        this.listener=listener;
    }
    public GsonRequest2(int method, String url, Class<T> tClass1, Map<String, String> map, Response.Listener<T> listener, Response.ErrorListener errorlistener) {
    ...
    public GsonRequest2(String url, Class<T> clazz, Response.Listener<T> listener, Response.ErrorListener errorListener){
